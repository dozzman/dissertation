...
%
A piece of software called OCaml-Java aims to merge the best aspects of both OCaml and Java together to create a better OCaml programming solution. It achieves this by compiling OCaml code to Java bytecode, thus allowing it to run on
almost any JVM.
...
it's use and how it manages to provide the user with concurrency when writing parallel OCaml code. 
