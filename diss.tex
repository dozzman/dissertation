...
and insertion sort for arrays smaller than a certain threshold. Furthermore the classic Introductions to Algorithms book \cite{coren2009} uses merge sort as an introduction to algorithms that exploit parallelism well.  is a mixture of
...
\subsection{Merge Sort Speedup}
\label{subsec:merge_sort_speedup}

%
% Speedup Graph in relation to merge sort 
%
...
\subsection{Fibonacci Speedup}
\label{subsec:fibonacci_speedup}
%
% Speedup Graph in relation to fibonacci
%

%
% Differences between speedup demonstrated by merge sort and that demonstrated by fibonacci calculations.
%
